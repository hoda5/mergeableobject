...
import { defDoc, stringType, numberType, complex } from "./types"
...
const remoto = testRepository<
    {
        clientes: {
            [clienteId: string]: typeof defCliente.purefields,
        },
    }
    >({
        name: "fakeDados",
...
const x = mergeableObject(defCliente)
const dadoMO = x.define({
    basePath: [
        () => "clientes",
    ],
    params: {},
